      ...
      <main className="flex-grow py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">About CropCare AI</h1>
            ...
            <div className="space-y-8 mb-8">
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="font-bold text-green-600 mb-2">Frontend</h3>
                  ...
                  <div>
                    <h3 className="font-bold text-green-600 mb-2">Backend & AI</h3>
                    <ul className="list-disc list-inside text-gray-600 space-y-1">
