      ...
      <main className="flex-grow py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Farmer Advisory</h1>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <div className="md:col-span-2">
                <div className="bg-gray-100 rounded-lg h-96 flex flex-col">
                  <div className="flex-grow p-4 overflow-y-auto">
                    <div className="space-y-4">
                      <div className="flex justify-start">
                        <div className="bg-green-100 text-gray-800 rounded-lg px-4 py-2 max-w-xs">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-800 mb-3">Sample Questions:</h3>
