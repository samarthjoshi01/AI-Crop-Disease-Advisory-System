        ...
        <div className="backdrop-blur-xl bg-white/70 dark:bg-gray-800/70 rounded-3xl shadow-2xl shadow-green-900/10 dark:shadow-black/30 border border-white/50 dark:border-gray-700/50 p-8 sm:p-10">
          ...
          {oauthError && (
            <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 rounded-xl text-red-600 dark:text-red-400 text-sm flex items-start gap-3">
              ...
              <span>OAuth login failed. Please try again or use email/password.</span>
            </div>
          )}
          ...
          <button
            ...
            className="w-full py-3 mb-6 bg-gray-900 dark:bg-white dark:text-gray-900 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 flex items-center justify-center gap-3 hover:bg-gray-800 dark:hover:bg-gray-100"
          >
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-sm text-gray-400 dark:text-gray-500">or continue with email</span>
            <div className="flex-1 h-px bg-gray-200 dark:bg-gray-700"></div>
          </div>
